...
abstract class $ProductModalCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int id, String title, String description, num price, String image});
}
...
class _$_ProductModal implements _ProductModal {
  ...
  @override
  String toString() {
    return 'ProductModal(id: $id, title: $title, description: $description, price: $price, image: $image)';
  }
...
abstract class _ProductModal implements ProductModal {
  const factory _ProductModal(
      ...
      required final String image}) = _$_ProductModal;
