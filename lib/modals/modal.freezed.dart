...
/// @nodoc
mixin _$Products {
  List<Data>? get modalList => throw _privateConstructorUsedError;
...
class _$ProductsCopyWithImpl<$Res, $Val extends Products>
  ...
  @override
  $Res call({
    Object? modalList = freezed,
  }) {
    return _then(_value.copyWith(
      modalList: freezed == modalList
          ? _value.modalList
          : modalList // ignore: cast_nullable_to_non_nullable
              as List<Data>?,
    ) as $Val);
  }
}
...
class _$_Products implements _Products {
  const _$_Products({required final List<Data>? modalList})
      : _modalList = modalList;

  factory _$_Products.fromJson(Map<String, dynamic> json) =>
      _$$_ProductsFromJson(json);

  final List<Data>? _modalList;
  @override
  List<Data>? get modalList {
    final value = _modalList;
    if (value == null) return null;
    if (_modalList is EqualUnmodifiableListView) return _modalList;
  ...
  @override
  String toString() {
    return 'Products(modalList: $modalList)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._modalList, _modalList));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_modalList));
...
abstract class _Products implements Products {
  const factory _Products({required final List<Data>? modalList}) = _$_Products;
...
class _$_Data implements _Data {
  ...
  @override
  String toString() {
    return 'Data(id: $id, title: $title, description: $description, price: $price, image: $image)';
  }
...
abstract class _Data implements Data {
  const factory _Data(
      ...
      required final String? image}) = _$_Data;
